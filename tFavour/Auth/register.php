        ...
        <div class="container d-flex justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="login.php">Se connecter</a></li>
                </ul>
                        ...
                        <div class="card-body">
                            <form action="backend/registerbackend.php" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input required class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirm password" name="cfpassword" />
