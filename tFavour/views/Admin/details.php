                                                        ...
                                                        <form>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control" type="text" disabled value="<?php echo $_SESSION['libelle']; ?>" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Date début du concours</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control date-picker" disabled value="<?php echo $_SESSION['dateDebut']; ?>" type="text" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Date fin du concours</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control date-picker" disabled value="<?php echo $_SESSION['dateFin']; ?>" type="text" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Début des inscriptions</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control date-picker" disabled value="<?php echo $_SESSION['dateDebutInscription']; ?>" type="text" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Fin des inscriptions</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control date-picker" disabled value="<?php echo $_SESSION['dateFinInscription']; ?>" type="text" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
