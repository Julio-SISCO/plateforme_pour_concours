                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $candidate['nom'] ?></td>
                                                                    <td><?= $candidate['prenoms'] ?></td>
                                                                    <td><?= $candidate['genre'] ?></td>
                                                                    <td><?= $candidate['naissance'] ?></td>
                                                                    <td><?= $candidate['nationalite'] ?></td>
                                                                    <td><?= $candidate['bac'] ?></td>
                                                                    <td><?= $candidate['serie'] ?></td>
                                                                    <td>
                                                                        <div>
                                                                            <?php
                                                                            ...
                                                                            ?>
                                                                                    <button class="btn waves-effect waves-light btn-info btn-icon" onclick="openPopup('<?= $path ?>')"><i class="icofont icofont-info-square"></i></button>
                                                                            <?php
                                                                                }
                                                                            } else {
                                                                                echo "Sans documents";
