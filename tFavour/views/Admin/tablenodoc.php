                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12">
                                                <!-- Popup container -->
                                                <div class="card p-5">
                                                    <table id="inscriptionTable" class="display">
                                                        <thead>
                                                            <tr>
                                                                <th>Photo</th>
                                                                <th>Nom</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $candidates = getCandidatesWithoutDocuments();
                                                            ...
                                                            foreach ($candidates as $candidate) {
                                                                ...
                                                                echo '<td>
                                                                    <div class="card-attribute">
                                                                        <img class="profile-image logo-photo" src="' . $photopath . '" alt="Photo">
                                                                    </div>                                                                 
                                                                </td>';
                                                                echo '<td>' . $candidate['nom'] . '</td>';
                                                                echo '<td>' . $candidate['prenoms'] . '</td>';
                                                                echo '<td>' . $candidate['genre'] . '</td>';
                                                                echo '<td>' . $candidate['naissance'] . '</td>';
                                                                echo '<td>' . $candidate['nationalite'] . '</td>';
                                                                echo '<td>' . $candidate['bac'] . '</td>';
                                                                echo '<td>' . $candidate['serie'] . '</td>';
                                                                echo '<td> Sans documents </td>';
                                                                echo '</tr>';
                                                            }
                                                            ?>
                                                        </tbody>
