                                            ...
                                            <div class="card col-12">
                                                <div class="pd-20 card-body mb-30">
                                                    ...
                                                    <div class="pd-20 card-box mb-30">
                                                        <div class="clearfix">
                                                            <div class="pull-left">
                                                                <h4 class="text-blue h4">Modifier les infos du conours </h4>
                                                                <p class="mb-30"></p>
                                                            </div>
                                                        </div>
                                                        <form method="post" action="backend/editbackend.php">
                                                            <input class="form-control" type="text" value="<?php echo $_SESSION['concoursId']; ?>" hidden name="idc" />
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Libelle</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control" type="text" value="<?php echo $_SESSION['libelle']; ?>" name="libelle" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Date début du concours</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control" type="date" value="<?php echo $_SESSION['dateDebut']; ?>" name="debut" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Date fin du concours</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control" value="<?php echo $_SESSION['dateFin']; ?>" type="date" name="fin" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Début des inscriptions</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control" value="<?php echo $_SESSION['dateDebutInscription']; ?>" type="date" name="debutinsc" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-12 col-md-4 col-form-label">Fin des inscriptions</label>
                                                                <div class="col-sm-12 col-md-8">
                                                                    <input class="form-control" value="<?php echo $_SESSION['dateFinInscription']; ?>" type="date" name="fininsc" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row text-center">
                                                                <div class="col-sm-12 col-md-6">
                                                                    <a href="details.php" class="btn btn-danger col-md-6">Retour</a>
                                                                </div>
                                                                <div class="col-sm-12 col-md-6">
                                                                    <button class="btn btn-success col-md-6" type="submit">Valider</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
