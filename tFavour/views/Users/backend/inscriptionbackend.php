...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id']) && isset($_SESSION['username'])) {
        ...
        try {
            ...
            if ($photo_url != null) {
                $result = saveCandidature($conn, $nom, $prenom, $photo_url, $date_naissance, $sexe, $nationalite, $annee_bac, $serie, $concoursId, $user_id);
                ...
                $conn = null;
                if ($is_Naissance_uploaded && $is_Nationalite_uploaded && $is_attestationBac_uploaded)
