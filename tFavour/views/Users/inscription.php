      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="card shadow-lg border-0 rounded-lg mt-5">
            ...
            <div class="card-body" style="background-color: #67b8c5aa;">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="file" class="form-control" id="copie_naissance" name="copie_naissance" accept=".pdf" required>
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-6">
                    <div class="form-group mb-3 mb-md-0">
                      ...
                      <input type="file" class="form-control" id="copie_nationalite" name="copie_nationalite" accept=".pdf" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="file" class="form-control" id="attestation_bac" name="attestation_bac" accept=".pdf" required>
                    </div>
                  </div>
                </div>
                <div class="form-group text-center">
                  <button type="submit" class="btn btn-lg page-scroll" style="background-color: #048dc8aa;">Soumettre la Candidature</button>
                </div>
              </form>
            </div>
