                ...
                <div class="card border-primary rounded-0">
                    <div class="card-header p-0">
                        <div class="bg-info text-white text-center py-2">
                            <h3><i class="fas fas-user"></i>Inscrivez-vous</h3>
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <input type="password" class="form-control" id="nombre" name="cfpassword"
                        ...
                        <div class="text-center">
                            <input type="submit" value="S'inscrire" class="btn btn-info btn-block rounded-0 py-2">
                        </div>
                        <div class="text-center mt-2">
                            <p>J'ai déjà un compte ?<a href="login.php">Se connecter </a></p>
                        </div>
                    </div>
