...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 col-md-offset-2 intro-text">
              <h1>La Plateforme Du Concours D'entrée A 
                l'IAI</h1>
                <div id="get-touch a">
                  <div class="container">
                    <div class="row">
                      <div class="col-xs-12 col-md-6 col-md-offset-1">
                        <h3>Connectez-vous maintenant pour continuer</h3>
                        <p>La demande de candidature est totalement gratuite</p>
                        <a href="auth/login.php" class="btn btn-custom btn-lg page-scroll">Se
                          Connecter</a>
                        <a href="auth/register.php" class="btn btn-custom btn-lg page-scroll">S'inscrire</a>
                      </div><br>
                    </div>
                  </div>
                </div>
  ...
  <div id="about">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-md-6"> <img src="assets/img/about1.jpg" class="img-responsive" alt=""> </div>
