            ...
            <div class="user-info-dropdown mx-4">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="../../auth/backend/logoutbackend.php"><i class="dw dw-logout"></i>Deconnexion</a>
                    </div>
                </div>
            </div>
    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Organiser un nouveau concours</h4>
                        <p class="mb-30"></p>
                    </div>
                </div>
                <form method="post" action="backend/newbackend.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input class="form-control" type="date" name="debutinsc" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-4 col-form-label">Fin des inscriptions</label>
                        <div class="col-sm-12 col-md-8">
                            <input class="form-control" type="date" name="fininsc" />
                        </div>
                    </div>
                    <div class="form-group justify-content-center">
                        <div class=" text-center bg-warning p-1 m-4 ">
                            <small>
                                <span>Si vous validez se formulaire, le concours actuel ne sera plus valide.</span>
                            </small>
                            <br>
                            <small>
                                <span>
                    ...
                    <div class="form-group row text-center">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <button class="btn btn-success col-md-6" type="submit">Continuer</button>
                        </div>
                    </div>
                </form>
            </div>
