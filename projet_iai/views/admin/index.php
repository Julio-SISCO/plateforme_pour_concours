...
<body>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="index.html">
                <h3 class="dark-logo"><strong>IAI ADMIN</strong></h3>
                <h3 class="light-logo" style="color:white;"><strong>IAI ADMIN</strong></h3>
            </a>
    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <div class="title pb-20">
                <h2 class="h3 mb-0">Aperçu des Statistiques</h2>
            </div>
            ...
            <div class="row pb-10">
                <div class="col-md-9 mb-20">
                    <div class="card-box height-100-p pd-20">
                        <div class="d-flex flex-wrap justify-content-between align-items-center pb-0 pb-md-3">
                            <div class="h5 mb-md-0">Histogramme des inscrits par nationnalité</div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mb-20  h-100">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 card-box height-100-p widget-style3">
                                    ...
                                    <ul>
                                        ...
                                        foreach ($results as $result) {
                                            ...
                                            <li class="d-flex flex-wrap align-items-center">
                                                <div class="icon">
                                                    <img src="../../assets/vendors/images/flags/doigt.png" alt=""
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                    <div class="card-box pd-30 pt-10 height-100-p">
                        <h2 class="mb-30 h4">Nationalités</h2>
                        <div class="browser-visits">
                            <ul>
                                <?php
                                require_once '../../functions/getImages.php';
                                ...
                                foreach ($results as $result) {
                                    ...
                                    <li class="d-flex flex-wrap align-items-center">
                                        <div class="icon">
                                            <img src="<?= flags($nationalite) ?>" alt="" class="rounded-circle"
                                                style="width: 30px !important; height: 30px !important;" />
                                        </div>
                                        <div class=" browser-name">
                                            <?= $nationalite ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 mb-30 h-100">
                    <div class="card-box pd-30 pt-10 height-100-p">
                        <h2 class="mb-30 h4">Séries</h2>
                        <div class="browser-visits">
                            <ul>
                                <?php
    ...
    <script>
        ...
        var statsNationalite = <?php require_once '../../functions/getters.php';
        echo getStatsByNationalite(); ?>;
