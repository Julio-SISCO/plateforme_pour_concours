            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form method="post" action="backend/editbackend.php" >
                            <input class="form-control" type="text" 
                                value="<?php echo $_SESSION['concoursId']; ?>" hidden name="idc" />
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-4 col-form-label">Libelle</label>
                        <div class="col-sm-12 col-md-8">
                            <input class="form-control" type="text" 
                                value="<?php echo $_SESSION['libelle']; ?>"  name="libelle"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input class="form-control"  type="date"
                                value="<?php echo $_SESSION['dateDebut']; ?>" name="debut" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-4 col-form-label">Date fin du concours</label>
                        <div class="col-sm-12 col-md-8">
                            <input class="form-control"  value="<?php echo $_SESSION['dateFin']; ?>"
                            type="date" name="fin" />
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input class="form-control" 
                                value="<?php echo $_SESSION['dateDebutInscription']; ?>"  type="date" name="debutinsc" />
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input class="form-control" 
                                value="<?php echo $_SESSION['dateFinInscription']; ?>"  type="date" name="fininsc" />
                        </div>
                    </div>
