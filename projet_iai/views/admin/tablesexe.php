        ...
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                <div class="pd-20 card-box">
                    <h5 class="h4 text-blue mb-20">Liste par nationalité</h5>
                    <div class="tab">
                        <div class="row clearfix">
                            <div class="col-md-2 col-sm-12">
                                <ul class="nav flex-column vtabs nav-tabs customtab" role="tablist">
                                    ...
                                    $genres = getDistinctByGender();
                                    if ($genres) {
                                        foreach ($genres as $index => $genre) {
                                            $tabId = 'tab' . $index;
                                            $tabName = ucfirst($genre); 
                                            ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?= $index === 0 ? 'active' : '' ?>" data-toggle="tab" href="#<?= $tabId ?>"
                                                    role="tab" aria-selected="true"><?php echo $genre; ?>
                                                </a>
                                            </li>
                                        <?php } ?>
                                    <?php } ?>
                                            ...
                                            <div class="tab-pane fade <?= $index === 0 ? 'show active' : '' ?>" id="<?= $tabId ?>" role="tabpanel">
                                                <div class="pd-20">
                                                    <table class="data-table table stripe hover nowrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $candidates = getCandidatesByGender($genre);
                                                            if ($candidates) {
                                                                        ...
                                                                        <td>
                                                                            <span class="user-icon">
                                                                                <img src="../../assets/vendors/images/photo1.jpg"
                                                                                    alt="" style="width: 40px; border:40px;" />
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <?php foreach ($documents as $document) { ?>
                                                                                                ...
                                                                                                <a class="dropdown-item"
                                                                                                    href="<?php echo $document['doc_url']; ?>">
